...
class RejectPatternTest < Minitest::Test
  ...
  def test_remove_vowels
    ...
    letters.each do |letter|
      # Your code goes here
      remaining << letter if letter[/[^aeiouy]/]
    end
  ...
  def test_remove_words_containing_e
    ...
    selected = []
    words.each do |word|
      selected << word if word.include?("e") != true
    end
  ...
  def test_remove_dinosaurs
    ...
    animals.each do |animal|
      notasaurus << animal if animal.end_with?("saurus") == false
      end
  ...
  def test_remove_floats
    ...
    not_numbers = []
    elements.each do |element|
      not_numbers << element if element.class != Float
    end
  ...
  def test_remove_animals_starting_with_vowels
    ...
    remaining = []
    animals.each do |animal|
      remaining << animal unless animal[/\b[aeiou]\w*/]
    end
