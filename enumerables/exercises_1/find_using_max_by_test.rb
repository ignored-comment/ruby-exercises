...
class FindUsingMaxByTest < Minitest::Test
  ...
  def test_array_with_the_fewest_items
    ...
    # write code here
    smallest_array = arrays.max_by {|array| 100 - array.length}
  ...
  def test_smallest_number
    ...
    # write code here
    found = numbers.max_by {|number| Float::INFINITY - number}
  ...
  def test_most_programmers
    ...
    # write code here
    most_programmers = programmers.max_by {|key, value| value.length}
  ...
  def test_fewest_programmers
    ...
    # write code here
    fewest_programmers = programmers.max_by {|key, value| 20 - value.length}
